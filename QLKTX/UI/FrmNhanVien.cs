...
namespace QLKTX.UI
{
    public partial class FrmNhanVien : Form
    {
        ...
        {
            var dt = FrmMain.bS_Layer.Update(txtMaNV.Text.Trim(), txtCMND.Text.Trim(), txtHoTen.Text.Trim(), 
                txtSDT.Text.Trim(), txtEmail.Text.Trim(), txtDiaChi.Text.Trim(), Convert.ToInt32(txtLuong.Text.Trim()), txtMaNQL.Text.Trim(), strAvt.Trim(), ref error);
            if (dt)
            {
